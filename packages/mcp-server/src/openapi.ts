...
const REST_META: Record<string, { summary: string; tags: string[] }> = {
  ...
  'put /api/repos/order': { summary: '保存工作台卡片拖拽顺序', tags: ['仓库'] },
  'post /api/repos/{id}/activate': { summary: '激活仓库（刷新最近打开时间，不改卡片顺序）', tags: ['仓库'] },
  ...
  'get /api/repos/{id}/merge/blame': { summary: '冲突文件两侧 blame', tags: ['只读'] },
  'get /api/repos/{id}/merge/survey': { summary: '合并矩阵批量预演', tags: ['只读'] },
  'get /api/repos/{id}/merge/order': { summary: '建议合入顺序', tags: ['只读'] },
  'get /api/repos/{id}/mr/prepare': { summary: '开 PR/MR 前只读解析', tags: ['只读'] },
